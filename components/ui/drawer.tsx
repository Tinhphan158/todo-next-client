...
function DrawerOverlay({
  ...
  return (
    <DrawerPrimitive.Overlay
      ...
      className={cn(
        "data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0 fixed inset-0 z-50 bg-black/10",
        shouldBlur
...
function DrawerContent({
  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      <DrawerOverlay shouldBlur={shouldBlur} />
